...
from memat.utils.util import get_gard_norm, huber_loss, mse_loss
from memat.utils.valuenorm import ValueNorm
...
class MATTrainer:
    ...
    def train(self, buffer):
        ...
        memory_stats = self.policy.get_memory_stats()
        if memory_stats:
            train_info.update(memory_stats)
